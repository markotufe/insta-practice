...
export async function createUsers() {
  ...
  const users = [
    ...
    // },
    {
      username: "pera2137777",
      fullName: "pera7 Gavrilovic",
      emailAddress: "pera767867867@test.test",
      registeredAt: Date.now(),
      password: "123456",
    },
    {
      username: "pera8546878",
      fullName: "Pera8 Masic",
      emailAddress: "pera8352359@test.test",
      registeredAt: Date.now(),
      password: "123456",
    },
    {
      username: "pera92352367",
      fullName: "pera9 Vukoicic",
      emailAddress: "pera9436348@test.test",
      registeredAt: Date.now(),
      password: "123456",
    },
    {
      username: "pera102423699",
      fullName: "Pear10 Gavrilovic",
      emailAddress: "Pera1124121@test.test",
      registeredAt: Date.now(),
      password: "123456",
    },
  ];
